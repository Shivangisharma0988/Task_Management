...
<?php echo anchor("admin/add_designation",'Add Designation',['class'=>'btn btn-primary']); ?>
<center><h1><U>ALL DESIGANTION</h1></U></center>
<hr>
<div class="table-id">
...
<td>
<?php echo $article->dname ?>
</td>
<td>
<?php echo form_open('admin/delete_des'),
   ...
   <td>
<?= anchor("admin/edit_designation/{$article->id}",'Edit',['class'=>'btn btn-primary']); ?>
</td>
</td>
</tr>
