...
<div class="container">
<br/>
<?php echo form_open_multipart("admin/update_designation/{$article->id}",['class'=>'form-horizontal']); ?>
...
<form>
  ...
  <center>
    ...
    <legend>EDIT Designation</legend>  </center>
       <div class="row">
      <div class="col-lg-6"><div class="form-group">
      <label for="staticUsername">Designation</label><br/>
     <?php echo form_input(['name'=>'dname','placeholder'=>'Designation','value'=>set_value('dname',$article->dname)]); ?>
     <?php if(!empty($error['dname'])){print_r($error['dname']); }?>
                </div></div>
<br><br>
    <div>
