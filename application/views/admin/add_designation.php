...
<div class="container">
<br/>
<?php echo form_open_multipart('admin/store_designation',['class'=>'form-horizontal']); ?>
...
<form>
  ...
  <center>
    ...
    <legend>ADD Designation</legend>  </center>
   
    <div class="row">
      <div class="col-lg-6"><div class="form-group">
      <label for="staticUsername">Designation</label><br/>
     <?php echo form_input(['name'=>'dname','placeholder'=>'Designation']) ?>
